...
class User(Table):
    ...
    password = Column("VARCHAR(64)",
                      constraints="NOT NULL DEFAULT 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1'")  # Hashed
...
class Product(Table):
    ...
    quantity = Column("INTEGER", constraints=f"NOT NULL DEFAULT 0")
