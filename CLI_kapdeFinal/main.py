...
def login():
    ...
    if key == "1":
        ...
        while a:
            ...
            password = sha256(pwinput(prompt='Enter your password: ', mask='\u2022').encode('utf-8')).hexdigest()
        ...
        while True:
            password = sha256(pwinput(prompt='Enter your password: ', mask='\u2022').encode('utf-8')).hexdigest()
            if password == "d74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1":
                admin_menu()
            break
